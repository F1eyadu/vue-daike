<template>
    <div class="container">
        ...
        <van-row class="row tip" type="flex" align="center">
            ...
            <van-button @click="isShowTimePicker = !isShowTimePicker" size="small">{{isShowTimePicker?'关闭预设':'设置时间'}}</van-button>
        </van-row>
