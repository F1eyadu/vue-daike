    ...
    <div class="course">
        ...
        <van-popup v-model="isShowDetail" position="bottom" :overlay="true">
            <van-row class="row" type="flex" align="center">
                ...
                <van-col span="10">{{course.school}}</van-col>
            </van-row>
            ...
            <van-row class="row" type="flex" align="center">
                ...
                <van-col span="10">{{course.courseName}}</van-col>
            </van-row>
            ...
            <van-row v-show="course.hasReward" class="row" type="flex" align="center">
                ...
                <van-col span="10">¥ {{course.reward}}</van-col>
            </van-row>
            ...
            <van-row v-show="course.hasName" class="row" type="flex" align="center">
                ...
                <van-col span="10"> {{course.publisherName}}</van-col>
            </van-row>
            ...
            <van-row v-show="course.receiverName" class="row" type="flex" align="center">
                ...
                <van-col span="10">{{course.receiverName}}</van-col>
            </van-row>
            ...
            <van-row  class="row" type="flex" align="center">
                ...
                <van-col span="10">{{course.courseTime}}</van-col>
            </van-row>
            ...
            <van-row  class="row" type="flex" align="center">
                ...
                <van-col span="10">{{course.courseClass}}</van-col>
            </van-row>
            ...
            <van-row  class="row" type="flex" align="center">
                ...
                <van-col span="10">{{course.coursePlace}}</van-col>
            </van-row>
            ...
            <van-row v-show="course.hasStuId" class="row" type="flex" align="center">
                ...
                <van-col span="10">{{course.studentId}}</van-col>
            </van-row>
            ...
            <van-row  class="row" type="flex" align="center">
                ...
                <van-col span="10">{{course.publishTime}}</van-col>
            </van-row>
            ...
            <van-row v-show="course.closeTime" class="row" type="flex" align="center">
                ...
                <van-col span="10">{{course.closeTime}}</van-col>
            </van-row>
            ...
            <van-row v-show="course.hasPhone" class="row" type="flex" align="center">
                ...
                <van-col span="10">{{course.phone}}</van-col>
            </van-row>
            ...
            <van-row v-show="course.remark" class="row" type="flex">
                ...
                <van-col span="17">{{course.remark}}</van-col>
            </van-row>
        </van-popup>
    </div>
</template>
