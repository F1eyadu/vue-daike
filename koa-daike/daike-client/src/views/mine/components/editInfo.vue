<template>
    <div>
        ...
        <van-cell-group class="box">
            ...
            <van-field v-model="editInfo.school" required label-align="left" clearable label="学校" readonly placeholder="请输入学校名称" @focus="showSchoolSearch" />
        ...
        <van-actionsheet v-model="isShowCelectSchool" title="输入学校名称查询">
            <van-search v-model="schoolName" placeholder="输入学校名" show-action @search="onSearchSchool">
